...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//first.jsp가 반환
			const hash = javascript: function a(){setTimeout(function(){alert('악성 스크립트 실행')}, 1000)}; a();
			if(hash) widow.location.href = decodeURIComponent(hash); // hash 내용을 uri로 구성
			window.addEventListener('hashChange',function() {
				widow.location.href = decodeURIComponent(window.location.hash.slice(1)); 
