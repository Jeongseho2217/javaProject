...
public class StudentMain {
	...
	// 프로그램 실행 테스트 진행 후 오류발생하면 수정하고 기록
	// getStdInfo(Scanner)메서드에 대해 insert와 update에 대해 학번 입력을 다르게 진행하도록 수정
	// insert 학번 입력 받기 / upd 학번 입력 x
	
	public static void main(String[] args) {
		// 개발코드 프로그램 실행 절차를 기술
		
		IStudentDAO dao = new StudentDAO(); // 객체 생성시 DB 자동 연결
		...
		while(true) {
			...
			case "1" :
				...
				stdNo = sc.nextLine();
				dao.insertStudent(ReadWrite.getStdInfoWithoutID(sc, stdNo));
