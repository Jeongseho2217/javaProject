...
public class MemberMain {
	...
	public static void main(String[] args) {
		...
		String address = sc.next(); // 주소는 공백 포함
...
//			System.out.println(memDto.getMemPass());
//			System.out.println(memDto.getMemName());
//			System.out.println(memDto.getMemPhone());
//			System.out.println(memDto.getMemAddress());
//		} else {
