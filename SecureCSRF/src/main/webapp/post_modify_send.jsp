...
try
{
	...
	String db_address = "jdbc:oracle:thin:@localhost:29889/xepdb1";
	String db_username = "sql_select";
	String db_pwd = "1234";
    Connection connection = DriverManager.getConnection(db_address, db_username, db_pwd);
    String S_NAME = (String)session.getAttribute("S_name");
    String S_csrf = request.getParameter("CSRF_TOKEN");
	...
	if(S_NAME.equals(writer) && S_csrf.equals(csrf_token)){ // 공격자
